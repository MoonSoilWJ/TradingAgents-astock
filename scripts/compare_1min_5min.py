...
SECTOR_ETF_MAP = {
    ...
    "生物制药": ("512010", "医药ETF"), "钢铁行业": ("515210", "钢铁ETF"),
    "煤炭行业": ("515220", "煤炭ETF"), "有色金属": ("512400", "有色金属ETF"),
    "电力行业": ("159611", "电力ETF"), "发电设备": ("159637", "电力设备ETF"),
    "电器行业": ("159996", "家电ETF"), "酿酒行业": ("512690", "酒ETF"),
    "化工行业": ("516020", "化工ETF"), "金融行业": ("512800", "银行ETF"),
    "房地产":   ("512200", "房地产ETF"), "传媒娱乐": ("512980", "传媒ETF"),
