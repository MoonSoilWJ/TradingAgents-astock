...
class AgentState(MessagesState):
    ...
    instrument_type: Annotated[str, "stock or etf — drives analyst pipeline and decision framework"]
    ...
    research_rating: Annotated[str, "5-tier rating from the Research Manager"]
